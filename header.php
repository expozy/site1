...
<!-- CORE SYSTEM SETTINGS -->
		...
		<script  src="/assets/js/globals.js" charset="utf-8"></script>
...
<?php 	 if($core->devMode && $user->logged_in) { ?>
			
	<div style="display: none;" id="tailwindCss"></div>
	<div style="width:100px; height: 50px;position: fixed; right: 100px; bottom: 100px; background-color: red; z-index: 1000;" id="dev_save">Save</div>
